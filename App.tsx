...
const s0 = StyleSheet.create({
  ...
  sideE: { fontSize: 25 },
  sideT: { fontSize: 14, fontWeight: "900", color: INK },
  ...
  promoE: { fontSize: 36 },
  promoT: { fontSize: 19, fontWeight: "900", color: INK },
  promoS: { fontSize: 15, fontWeight: "700", color: "#746359" },
